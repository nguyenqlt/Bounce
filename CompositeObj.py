...
f = frame()
## QUADCOPTER
body=ellipsoid(frame= f, pos=(0,h,0), size=(3, 1, 5))
part1=ellipsoid(frame= f, pos=(1,h,0), size = (1.5, 0.5, 2.5), color = color.red)
part2=ellipsoid(frame= f, pos=(1,h,1), size = (1.5, 0.5, 2.5), color = color.red)
part3=ellipsoid(frame= f, pos=(-1,h,-1), size = (1.5, 0.5, 2.5), color = color.red)
part4=ellipsoid(frame= f, pos=(-1,h,1), size = (1.5, 0.5, 2.5), color = color.red)
